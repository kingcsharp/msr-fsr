...
export class WipComponent implements OnInit, AfterViewInit {
  ...
  getEngineerColumns() {
    return [
      ...
      new ColumnsSaved({ id: 'qty', label: 'Qty', visible: true, type: EnumColumnType.Number, styles: { 'width': '6rem' } }),
      new ColumnsSaved({ id: 'startDate', label: 'Start Date', visible: true, type: EnumColumnType.Date, formattingAngular: 'dd-MM-yyyy', formattingMoment: 'DD-MM-YYYY', isRanged: true }),
      new ColumnsSaved({ id: 'dueDate', label: 'Due Date', visible: true, type: EnumColumnType.Date, formattingAngular: 'dd-MM-yyyy', formattingMoment: 'DD-MM-YYYY', isRanged: true }),
  ...
  getBuyerColumns() {
    return [
      ...
      new ColumnsSaved({ id: 'invoiceDate', label: 'Invoice Date', visible: true, type: EnumColumnType.Date, formattingAngular: 'dd-MM-yyyy', formattingMoment: 'DD-MM-YYYY', isRanged: true }),
      new ColumnsSaved({ id: 'status', label: 'Status', visible: true, type: EnumColumnType.Template, templateName: this.statusCol }),
    ];
  }
}
