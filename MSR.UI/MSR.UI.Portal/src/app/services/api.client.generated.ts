...
export class WorkOrderService {
    ...
    portal(customerId: number | undefined, partName: string | null | undefined, partId: number | null | undefined, fromDate: Date | undefined, toDate: Date | undefined, pageNumber: number | undefined, pageSize: number | undefined, sort: Sort[] | null | undefined, filter_Field: string | null | undefined, filter_Operator: string | null | undefined, filter_Value: any | null | undefined, filter_Logic: string | null | undefined, filter_Filters: Filter[] | null | undefined, version: string): Observable<AuditActionResultOfICollectionOfPortalWorkOrderView> {
        ...
        if (filter_Field !== undefined && filter_Field !== null)
            url_ += "Filter.Field=" + encodeURIComponent("" + filter_Field) + "&";
        if (filter_Operator !== undefined && filter_Operator !== null)
        ...
        if (filter_Logic !== undefined && filter_Logic !== null)
            url_ += "Filter.Logic=" + encodeURIComponent("" + filter_Logic) + "&";
        if (filter_Filters !== undefined && filter_Filters !== null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AuditActionResultOfICollectionOfPortalWorkOrderView>><any>_observableThrow(e);
                }
            } else
                return <Observable<AuditActionResultOfICollectionOfPortalWorkOrderView>><any>_observableThrow(response_);
        }));
    }

    protected processPortal(response: HttpResponseBase): Observable<AuditActionResultOfICollectionOfPortalWorkOrderView> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AuditActionResultOfICollectionOfPortalWorkOrderView.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
/** Base class for an API call with a typed result */
export class AuditActionResultOfICollectionOfPortalWorkOrderView extends AuditActionResult implements IAuditActionResultOfICollectionOfPortalWorkOrderView {
    ...
    static fromJS(data: any): AuditActionResultOfICollectionOfPortalWorkOrderView {
        data = typeof data === 'object' ? data : {};
...
/** Base class for an API call with a typed result */
export interface IAuditActionResultOfICollectionOfPortalWorkOrderView extends IAuditActionResult {
    object?: PortalWorkOrderView[] | undefined;
}
