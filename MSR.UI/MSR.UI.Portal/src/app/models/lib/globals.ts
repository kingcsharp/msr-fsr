...
export class Globals {
  ...
  selectCustomerObservable: Observable<any> =
    this.selectCustomerSource.asObservable();
  ...
  hasActivityPrivilegeByTableName(tableName, privilege) {
    ...
    const ret =
      this.user.approvalPrivileges[approvalEnum].indexOf(privilege) > -1;
    return ret;
  }
