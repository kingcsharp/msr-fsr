...
describe('User Functionality', () => {
    it('TC354_EditUserRole', () => {
        ...
        cy.route({
            method: 'PATCH',
            url: '/v1/Role',
            response: { "object": { "id": 32, "name": "MegaSuperAdmin2", "isCertificationRole": false, "menus": [], "permissions": null, "inheritedPermissions": null, "parentRoles": [], "hasAssignedUsers": false, "lastUpdatedOn": "2020-08-31T22:51:38.0919063Z", "lastUpdatedBy": 134, "lastUpdated": { "id": 134, "isActive": true, "userRoleId": null, "userName": "admin", "firstName": "Admin", "lastName": "Msrfsr", "fullName": "Admin Msrfsr", "title": "Admin", "email": "admin-msrfsr@cmhworks.com", "securityStamp": null, "phone": "5552221212", "supervisorId": 45, "supervisorName": "Mike Harvey", "locationId": 0, "locationName": null, "isAnswerUser": true, "customerId": 0, "lockoutEndDateUtc": null, "lockoutEnabled": false, "accessFailedCount": 0, "timeZoneId": 0, "lastUpdatedOn": "2020-06-05T23:16:32.637", "timeZone": null, "lastUpdatedBy": 134, "createdOn": "2020-06-05T19:13:53", "createdBy": 68, "roles": [], "fileModel": null }, "createdOn": "2020-08-31T22:43:06.56", "createdBy": 134, "created": { "id": 134, "isActive": true, "userRoleId": null, "userName": "admin", "firstName": "Admin", "lastName": "Msrfsr", "fullName": "Admin Msrfsr", "title": "Admin", "email": "admin-msrfsr@cmhworks.com", "securityStamp": null, "phone": "5552221212", "supervisorId": 45, "supervisorName": "Mike Harvey", "locationId": 0, "locationName": null, "isAnswerUser": true, "customerId": 0, "lockoutEndDateUtc": null, "lockoutEnabled": false, "accessFailedCount": 0, "timeZoneId": 0, "lastUpdatedOn": "2020-06-05T23:16:32.637", "timeZone": null, "lastUpdatedBy": 134, "createdOn": "2020-06-05T19:13:53", "createdBy": 68, "roles": [], "fileModel": null } }, "successMessage": "Role successfully updated", "errorMessages": [], "id": 0, "hasErrors": false, "hasValidationErrors": false }
        });
        ...
        cy.get('tbody').find('tr:first-child td').contains('32');
        cy.get('tbody').find('tr:first-child td').get('[data-cy=editRow').click();

        cy.get('[data-cy=isCertificationRole-checkbox]').click();
        cy.writeAndValidate('name-input', 'MegaSuperAdmin2');
        cy.multiselectFormClick('parentroles-modal', 'CEO');
