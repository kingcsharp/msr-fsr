...
describe('Workflow Group Functionality', () => {
    it('TC384_AddApprovalWorkflow', () => {
        ...
        cy.route({
            ...
            response:{
                "object": {
                    ...
                    "isActive": true,
                    "lastUpdatedOn": "2020-08-25T04:05:47.0959386Z",
                    "lastUpdatedBy": 134,
                    "lastUpdated": {
                        "id": 134,
                        "isActive": true,
                    ...
                    "createdOn": "2020-08-25T04:05:47.0959386Z",
                    "createdBy": 134,
                    "created": {
                        "id": 134,
                        "isActive": true,
                ...
                "successMessage": "Workflow has been successfully created.",
                "errorMessages": [],
                "id": 0,
                "hasErrors": false,
                "hasValidationErrors": false
        ...
        cy.get('[data-cy=name-input]').type('ApprovalTest').should('have.value', 'ApprovalTest');

        cy.multiselectFormClick('form-memberStages','OP and WI Document Approvals');
        cy.multiselectFormClick('form-activityMaps','Customers');
        ...
        //validate creation
        cy.writeAndValidate('searchbyname-grid','ApprovalTest');
