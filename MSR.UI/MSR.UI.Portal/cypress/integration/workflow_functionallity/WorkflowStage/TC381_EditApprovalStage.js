    ...
    it('TC381_EditApprovalStage', () => {
        ...
        cy.route({
            ...
            response:{
                ...
                "successMessage": "Workflow Stage has been successfully created.",
                "errorMessages": [],
                "id": 0,
                "hasErrors": false,
                "hasValidationErrors": false
        ...
        //edit 
        var wfsageName = 'Workflow Stage Test2';
        ...
        var wfstageNewName = 'Workflow Stage Test22';
        cy.get('[data-cy=name-input]').type(wfstageNewName).should('have.value', wfstageNewName);

        cy.multiselectFormClick('form-groups','Workflow Test');
