describe('WIP Menu Functionality', () => {
    it('TC66_WIPMenuPageClearViewButton', () => {
        ...
        cy.multiselectClick('locationname-input','Location1');
        cy.get('[data-cy=wipgrid-body]').should('have.length', 1)
        cy.get('[data-cy=myviews-button]').click()
        cy.get('[data-cy=clearview-button]').click()
        cy.get('[data-cy=wipgrid-body]').should('have.length', 10)
