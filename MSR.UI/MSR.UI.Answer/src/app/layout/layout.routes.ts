...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "core",
        loadChildren: () =>
          import("../pages/core/core-elements.module").then(
            (m) => m.CoreElementsModule
          ),
      },
      {
        path: "tables",
      ...
      },
      {
        path: "package",
        loadChildren: () =>
          import("../pages/package/package.module").then(
            (m) => m.PackageModule
          ),
      },
      {
      ...
      },
      {
        path: "monitors",
        loadChildren: () =>
          import("../pages/monitors/monitors.module").then(
            (m) => m.MonitorsModule
          ),
      },
      {
      ...
      },
      {
        path: "reporting",
        loadChildren: () =>
          import("../pages/reports/report.module").then((m) => m.ReportModule),
      },
      {
        path: "dashboards",
        loadChildren: () =>
          import("../pages/dashboards/dashboard.module").then(
            (m) => m.DashboardModule
          ),
      },
      {
      ...
      },
      {
        path: "wip",
        loadChildren: () =>
          import("../pages/wip/wip.module").then((m) => m.WipModule),
      },
      {
        path: "landing",
        loadChildren: () =>
