...
export class TemplatesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.templatesPrivileges = this.globals.getEnumPrivileges(
  ...
  getProcedureTemplates(event: LazyLoadEvent) {
    ...
    setTimeout(() => {
      callFunctionWithFilters(
        ...
        this.procedureStepTemplateService.procedureStepTemplateGet,
        event,
  ...
  delete() {
    this.procedureStepTemplateService
      .procedureStepTemplateDelete(
        this.procedureTemplateToDelete.id,
        env.apiVersion
      )
      .subscribe(
        responseHandler((response) => {
