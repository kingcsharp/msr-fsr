...
export class ProcedureCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.procedureTypeService
      .procedureTypeGet(null, null, null, null, null, null, env.apiVersion)
      .subscribe(
        responseHandler((procedureTypeGetResponse) => {
          this.availableProcedureTypes = procedureTypeGetResponse.object.map(
            (s) => {
  ...
  save() {
    ...
    createProcedureRequest.procedureTypeId =
      this.selectedProcedureType === undefined
        ? undefined
        : Number(this.selectedProcedureType);
    createProcedureRequest.tagType =
      createProcedureRequest.procedureTypeId === this.ncrProcedureType?.id
        ? this.procedure.tagType
        : undefined;
    ...
    this.procedureService
      .procedurePost(env.apiVersion, createProcedureRequest)
      .subscribe(
