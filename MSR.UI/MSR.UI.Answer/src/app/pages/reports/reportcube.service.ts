    ...
    public getReportColumns(reportInfo: ReportModel) {
        switch (reportInfo.name.replace(/\s/g, '') + reportInfo.subtitle.replace(/\s/g, '')) {
            ...
            case 'WorkInProcessbyWorkOrder':
                return [
                    new ColumnsSaved({ id: 'mainsub', label: 'Main/Sub', visible: true, type: this.enumColumnType.String, dropdownHeader: true, multipleValues: false   }),
            ...
            case 'CombinedFinancialDatabyWorkOrder':
                return [
                    ...
                    new ColumnsSaved({ id: 'specificationnumber', label: 'Procedure Name', visible: true, type: this.enumColumnType.String }),
                    new ColumnsSaved({ id: 'procedureid', label: 'Procedure ID', visible: true, type: this.enumColumnType.Number }),
                    new ColumnsSaved({ id: 'kitname', label: 'Kit Name', visible: true, type: this.enumColumnType.String }),
