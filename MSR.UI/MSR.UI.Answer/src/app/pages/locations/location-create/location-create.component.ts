...
export class LocationCreateComponent implements OnInit {
  ...
  getAvailableParentLocations() {
    ...
    this.locationService.locationGet(null, null, null, null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,env.apiVersion).subscribe(responseHandler((response) => {
  ...
  getLocationForEditorCreate() {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (this.locationToEditId !== 0) {
        ...
        this.globals.showLoader(true);
        this.locationService.locationGet(null, this.locationToEditId, null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null, env.apiVersion).subscribe(responseHandler((locationGetResponse) => {
