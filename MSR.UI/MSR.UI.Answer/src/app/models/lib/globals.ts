...
export class Globals {
    ...
    functionDic: any =  {"workflowPendingApprovalGet":["table","id","activityType","name","requestedChanges","workflowName","workflowGroupName","workflowCreatedByName","createdOn","createdByName","term","pageNumber","pageSize","sortAscending","version"],"partGet":["id","name","segregationType","partNumber","oemPartNumber","isKit","isActive","maximumCycles","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","term","pageNumber","pageSize","sortAscending","version"],"history":["purchaseId","workOrderItemNumber","customer","location","serialNumber","purchaseOrderNumber","qty","scheduledStartDate","scheduledEndDate","actualStartDate","actualEndDate","product","procedure","status","dispostion","term","pageNumber","pageSize","sortAscending","version"],"procedureStepTemplateGet":["id","title","text","term","pageNumber","pageSize","sortAscending","version"],"procedureTypeGet":["id","name","term","pageNumber","pageSize","sortAscending","version"],"procedureGet":["id","name","procedureTypeName","duration","durationType","revision","createdFullName","createdOn","lastUpdatedFullName","lastUpdatedOn","term","pageNumber","pageSize","sortAscending","version"],"userGet":["id","firstName","lastName","userName","title","supervisorName","primaryPhone","email","roles","isActive","isAnswerUser","createdOn","locationName","term","pageNumber","pageSize","sortAscending","version"],"roleGet":["id","name","isCertificationRole","parentRoles","assignedUsers","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","term","pageNumber","pageSize","sortAscending","version"],"customerGet":["id","name","address","phone","primaryContactUserId","secondaryContactUserId","locationId","isActive","primaryContactUserFullName","secondaryContactUserFullName","locationName","customerNumber","createdFullName","createdOn","status","term","pageNumber","pageSize","sortAscending","version"],"trainingCertification":["userId","employeeName","certificationName","certificationFromDate","certificationToDate","status","term","pageNumber","pageSize","sortAscending","version"],"locationGet":["parentId","id","internalAddress","name","createdFullName","createdOn","address1","city","state","postalcode","country","phone","parentName","timezoneDescription","address2","status","term","pageNumber","pageSize","sortAscending","version"],"product":["submittedDate","company","submittedByFullName","divisionFab","partKitNo","segregationType","procedureName","productName","representative","revision","equipmentCost","materialCost","salesTax","totalPrice","cycleTime","lastUpdateOn","lastUpdatedBy","term","pageNumber","pageSize","sortAscending","version"],"purchaseOrderGet":["id","name","customerReferencePO","invoicedBalance","uninvoicedBalance","balance","customerName","openDate","closeDate","totalPurchaseLimit","unusedAmount","revision","status","term","pageNumber","pageSize","sortAscending","version"],"purchaseGet":["id","mttn","purchaseOrderProductName","statusId","createdOn","term","pageNumber","pageSize","sortAscending","version"],"invoiceGet":["id","customerName","description","invoiceNumber","dueDate","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","amount","statusId","term","pageNumber","pageSize","sortAscending","version"],"workflowGet":["id","name","memberStages","activityMaps","isActive","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","term","pageNumber","pageSize","sortAscending","version"],"workflowStageGet":["id","isActive","name","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","term","pageNumber","pageSize","sortAscending","version"],"workflowGroupGet":["id","isActive","name","groupRoles","createdOn","createdByName","lastUpdatedOn","lastUpdatedByName","term","pageNumber","pageSize","sortAscending","version"],"equipmentMaintenanceGet":["id","locationName","createdOn","createdFullName","assignedToFullName","troubleState","maintenanceTask","pemLastCompletedDate","frequencyField","comments","statusName","term","pageNumber","pageSize","sortAscending","version"],"documentGet":["id","name","revision","lastUpdatedOn","lastUpdatedFullName","term","pageNumber","pageSize","sortAscending","version"],"helpGet":["id","friendlyURL","title","roles","term","pageNumber","pageSize","sortAscending","version"],"menu":["pageNumber","pageSize","sort","filters","version"]};
