describe('Workflow Group Functionality', () => {
    it('TC378_ApprovalWorkflowGrid', () => {
        ...
        cy.get('[data-cy=usertable-header]').contains('Workflow Name').click();
        cy.get('[data-cy=usertable-header]').contains('Id').click();
        cy.get('[data-cy=usertable-header]').contains('Member Stages').click();
        cy.get('[data-cy=usertable-header]').contains('Applicable Activities').click();
