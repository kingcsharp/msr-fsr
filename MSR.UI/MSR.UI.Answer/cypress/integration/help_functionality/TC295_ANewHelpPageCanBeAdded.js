describe('Help Functionality', () => {
    it('TC295_ANewHelpPageCanBeAdded', () => {
        ...
        cy.route({
            ...
            response: {
                "object": {
                    "id": 1,
                    "title": "asdasd",
                    "friendlyURL": "/people/roles",
                    "content": "<p>asdasdasda</p>",
                    "roles": [
                    ]
                },
                "successMessage": "HelpPage created successfully",
                "errorMessages": [],
                "id": 0,
                "hasErrors": false,
                "hasValidationErrors": false
        ...
        cy.get('[data-cy=title-input]').type("Sample Help Page").should('have.value', "Sample Help Page")
