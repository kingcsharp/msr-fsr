                ...
                stage('Build & Deploy UI to QA') {
                    ...
                    steps {
                        script {
                            ...
                            awsCodeBuild artifactEncryptionDisabledOverride: '', artifactLocationOverride: '', artifactNameOverride: '', artifactNamespaceOverride: '', artifactPackagingOverride: '', artifactPathOverride: '', artifactTypeOverride: 'NO_ARTIFACTS', awsAccessKey: 'AKIAWGEEZQAT64QN454I', awsSecretKey: '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', buildSpecFile: 'MSR.UI/MSR.UI.Answer/buildspec-answer-ui-qa.yml', buildTimeoutOverride: '', cacheLocationOverride: '', cacheModesOverride: '', cacheTypeOverride: 'NO_CACHE', certificateOverride: '', cloudWatchLogsGroupNameOverride: '', cloudWatchLogsStatusOverride: 'ENABLED', cloudWatchLogsStreamNameOverride: '', computeTypeOverride: '', credentialsId: '', credentialsType: 'keys', cwlStreamingDisabled: 'True', downloadArtifacts: 'false', downloadArtifactsRelativePath: '', envParameters: '', envVariables: '', environmentTypeOverride: '', exceptionFailureMode: 'DISABLED', gitCloneDepthOverride: '', imageOverride: '', insecureSslOverride: '', localSourcePath: '', overrideArtifactName: '', privilegedModeOverride: '', projectName: 'answer-ui', proxyHost: '', proxyPort: '', region: 'us-west-2', reportBuildStatusOverride: '', s3LogsEncryptionDisabledOverride: 'False', s3LogsLocationOverride: '', s3LogsStatusOverride: 'DISABLED', secondaryArtifactsOverride: '', secondarySourcesOverride: '', secondarySourcesVersionOverride: '', serviceRoleOverride: '', sourceControlType: 'jenkins', sourceLocationOverride: 'answer-codebuild-input', sourceTypeOverride: 'S3', sourceVersion: '', sseAlgorithm: '', workspaceSubdir: ''
