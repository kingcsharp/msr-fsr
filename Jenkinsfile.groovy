                ...
                stage('Build & Deploy UI to QA') {
                    ...
                    steps {
                        script {
                            ...
                            awsCodeBuild artifactEncryptionDisabledOverride: 'False', artifactLocationOverride: '', artifactNameOverride: '', artifactNamespaceOverride: '', artifactPackagingOverride: '', artifactPathOverride: '', artifactTypeOverride: 'NO_ARTIFACTS', awsAccessKey: 'AKIAWGEEZQAT64QN454I', awsSecretKey: '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', buildSpecFile: '', buildTimeoutOverride: '', cacheLocationOverride: '', cacheModesOverride: '', cacheTypeOverride: 'NO_CACHE', certificateOverride: '', cloudWatchLogsGroupNameOverride: '', cloudWatchLogsStatusOverride: 'DISABLED', cloudWatchLogsStreamNameOverride: '', computeTypeOverride: '', credentialsId: '', credentialsType: 'keys', cwlStreamingDisabled: 'True', downloadArtifacts: 'false', downloadArtifactsRelativePath: '', envParameters: '', envVariables: '', environmentTypeOverride: '', exceptionFailureMode: 'DISABLED', gitCloneDepthOverride: '', imageOverride: '', insecureSslOverride: '', localSourcePath: '', overrideArtifactName: 'False', privilegedModeOverride: '', projectName: 'answer-ui', proxyHost: '', proxyPort: '', region: 'us-west-2', reportBuildStatusOverride: '', s3LogsEncryptionDisabledOverride: 'False', s3LogsLocationOverride: '', s3LogsStatusOverride: 'DISABLED', secondaryArtifactsOverride: '', secondarySourcesOverride: '', secondarySourcesVersionOverride: '', serviceRoleOverride: '', sourceControlType: 'project', sourceLocationOverride: '', sourceTypeOverride: '', sourceVersion: '', sseAlgorithm: '', workspaceSubdir: ''
...
//                            } catch(e) {
//                                office365ConnectorSend color: "${RED}", message: "${env.BRANCH_NAME} build FAILED building/deploying the Message container. \n Error: ${e}", status: 'Failed', webhookUrl: "${WEBHOOK_URL}"
//                                currentBuild.result = 'FAILURE'
//                                sh "exit 1"
//                            }
//
