...
namespace Msr.Services.PrePro.Procedure
{
    ...
    public class SaveProcedureStepProcedure
    {
        ...
        [StoredProcedureParameter(SqlDbType.Decimal, ParameterName = "COUNTER_VALUE")]
        ...
        [StoredProcedureParameter(SqlDbType.NVarChar, Size = 8000, ParameterName = "DESTINATION")]
        ...
        [StoredProcedureParameter(SqlDbType.NVarChar, Size = 8000, ParameterName = "REFERENCE_THEORIES")]
        ...
        [StoredProcedureParameter(SqlDbType.Decimal, Size = 100, ParameterName = "CYCLE_COUNT")]
        ...
        [StoredProcedureParameter(SqlDbType.NVarChar, Size = 8000, ParameterName = "ReferenceProcs")]
        public string ReferenceProcs { get; set; }

        [StoredProcedureParameter(SqlDbType.NVarChar, Size = 8000, ParameterName = "precedingSteps")]
        public string PrecedingSteps { get; set; }

        [StoredProcedureParameter(SqlDbType.NVarChar, Size = 50, ParameterName = "DURATION")]
