...
namespace MSR.Answer.API.V1.Models
{
    ...
    public partial class UpdateProcedureStepRequest : IEquatable<UpdateProcedureStepRequest>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UpdateProcedureStepRequest)obj);
        }

        /// <summary>
        /// Returns true if UpdateProcedureStepRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateProcedureStepRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateProcedureStepRequest other)
        {
        ...
        public static bool operator ==(UpdateProcedureStepRequest left, UpdateProcedureStepRequest right)
        {
