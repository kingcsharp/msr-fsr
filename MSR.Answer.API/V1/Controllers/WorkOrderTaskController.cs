...
{ 
    ...
    { 
        ...
        [ValidateModelState]
        [SwaggerResponse(typeof(AuditActionResultOfWorkOrderTask))]
        ...
        { 
            ...
            exampleJson = "\"\"";
                        ...
                        ? JsonConvert.DeserializeObject<AuditActionResultOfWorkOrderTask>(exampleJson)
                        : default(AuditActionResultOfWorkOrderTask);            //TODO: Change the data returned
