...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse, tBtnSelect,
            ...
            tBtnSelect = '<button type="button" class="btn btn-md btn-success select-file-button" data-select-url="' + self.uploadUrl +'" data-call-back-id="' + self.referenceId + '" data-file-select-target-id="' + self.selectElement + '" data-target-section="' + self.section + '" data-toggle="modal" data-target="#select-images" title="Select Existing File"><i class="fa fa-list"></i> Select</button> '; 
            ...
            self.defaults = {
                layoutTemplates: {
                    ...
                    btnSelect: tBtnSelect, // added by Mike H
                ...
                fileActionSettings: {
                    ...
                    selectIcon: '<i class="glyphicon glyphicon-th-list"></i>', // added by Mike H
                    selectClass: 'btn btn-sm btn-kv btn-success btn-outline-secondary',// added by Mike H
                    selectTitle: 'Select Existing File',// added by Mike H
        ...
        _renderMain: function () {
            ...
            return self.mainTemplate.setTokens({
                ...
                'select': self._renderButton('select') //added by Mike H
            });
        ...
        _renderButton: function (type) {
            ...
            switch (type) {
                ...
                case 'select':
                    ...
                    tmplt = self._getLayoutTemplate('btnSelect');
                    break;
                default:
                    return '';
            }
