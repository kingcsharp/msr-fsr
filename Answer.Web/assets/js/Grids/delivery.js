function LoadDeliveryGrid(url, returnUrl) {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {
                label: 'Part Number',
                name: 'COMPANY_PART_NUMBER',
                index: 'COMPANY_PART_NUMBER',
                colmenu: false,
                editable: true,
                coloptions: {
                    sorting: false,
            ...
            $('.editpeople').on('click',
                function (e) {
                    ...
                    function confirmCallback() {
                        console.log("ok");
                        window.location.href = "/Delivery/Edit/" + callBackId;
                    }
