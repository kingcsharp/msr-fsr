...
define("moxman/interop/TinyMcePlugin", [
	...
	if (langCode && langCode != 'en') {
		tinymce.ScriptLoader.load((tinymce.PluginManager.urls.moxiemanager || tinymce.baseURL + '/plugins/moxiemanager') + Env.apiPageUrl + '?action=language&tinymce=true&code=' + langCode);
	}
});
