        ...
        AddSubPart: function () {
            ...
            $("#add-sub-part-row").click(function () {
                ...
                $('#sub-parts').append("<tr>" +
                    ...
                    "<td><input type='text' name='SubPartList[" + index + "].Qty'  class='form-control' data-val='true' onkeyup = 'javascript:checkType(this)' data-val-required='The Qty field is required.'/><span class=" + "text-danger field-validation-error" + " data-valmsg-for=" + "SubPartList[" + index + "].Qty" + " data-valmsg-replace=" + "true" + "></span></td>" +
