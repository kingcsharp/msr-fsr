                ...
                while (filtersLength--) {
                    ...
                    if (filterElem.val !== undefined && filterElem.val !== '') {
                        ...
                        if (filterElem.fromDate === undefined && filterElem.toDate === undefined) {
                            ...
                            console.log("in = gridjs = filterGrid");
...
app.service('grid', ['$sce', function ($sce) {
    ...
    this.extendedGridV2 = function (report, mode) {
        ...
        htmlCode +=
            '<a class="btn btn-success help-btn export-button"' +
    ...
    function createFilter2(columns) {
        ...
        while (length--) {
            ...
            if (col.elementName.toLocaleLowerCase() === "month" || col.elementName.toLocaleLowerCase().includes("date")) {
                filtersToAdd.push({
                    "text": "From Date",
                    "elementID": col.id,
                    "val": '',
