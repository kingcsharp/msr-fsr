        ...
        if (query) {
            ...
            if (chart.type == 'pie' || chart.type == 'donut') {
                ...
                if (chart.type == 'gauge') {
                    ...
                    if (chart.type == 'bar') {
                        //var length = query.data.length;
                        //for (var j = 0; j < length - 1; j++) {
                        //    if (chartLabelData[query.data[j][axisField]] === undefined) {
                        //        chartLabelData[query.data[j][axisField]] = [];
                        //        chartLabelData[query.data[j][axisField]].push(query.data[j]);
                        //    } else {
                        //        chartLabelData[query.data[j][axisField]].push(query.data[j]);
                        //    }
                        //}
                            ...
                            tooltip: {
                                format: {
                                    name: function (name, ratio, id, index) {
                                        var a = Object.keys(query.data[index]);
                                        a.splice(a.indexOf(id), 1);
                                        a.splice(a.indexOf(axisField), 1);
                                        var retStr = '';
                                        for (var j = 0; j < a.length; j++) {
                                            retStr += query.data[index][a[j]] + " | ";
