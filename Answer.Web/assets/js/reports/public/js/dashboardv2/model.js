app.service('dashboardv2Model', function ($http, $q, connection, reportService) {
    ...
    this.getDashboards = function (params, localapiparams, done) {
        var params = (params) ? params : {};
        //connection.get('/Report/dashboardsv2findall', params, function (data) {
        //    done(data);
        //}, undefined, localapiparams);
        connection.get('/Report/dashboardsv2findall', params, done, undefined, localapiparams);
    };

    this.getPromptsForDashboard = function ($scope, dashboard, done) {
        getDashboardPrompts($scope,
            dashboard,
            0,
            [],
            function (prompts) {
