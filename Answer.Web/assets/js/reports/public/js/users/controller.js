...
app.controller('AdminUsersCtrl', function ($scope, connection, $q, $filter, $window,$routeParams,$rootScope,PagerService) {
    $scope.deleteModal = 'assets/js/reports/partial/private/deleteModal.html';
    $scope.changePasswordModal = 'assets/js/reports/partials/users/changePassword.html';
    $scope.page = null;
    $scope.data = null;
    $scope.search = null;
    $scope.selectedRole = '';
    $scope.editUserModal = 'assets/js/reports/partials/users/edit.html';
    $scope.pager = {};
