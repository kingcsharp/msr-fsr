...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "A_COMPANIES"
            ...
            TopColumn = 0
         End
         Begin Table = "A_COMPANIES_HISTORY"
            Begin Extent = 
               Top = 6
               Left = 242
               Bottom = 114
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'A_V_COMPANIES_APPROVED_DATA_QUICK';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'A_V_COMPANIES_APPROVED_DATA_QUICK';
