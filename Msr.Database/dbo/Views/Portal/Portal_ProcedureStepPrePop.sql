CREATE VIEW dbo.Portal_ProcedureStepPrePop
AS
SELECT        dbo.A_PROCEDURE_STEPS.ID, p.OBJECT_ID AS ObjectId, o.LOCKED_BY AS LockedBy, o.UNLOCKED_BY AS UnlockedBy, o.CREATED_BY AS CreatedBy, o.CREATE_DATE AS CreatedDate, o.ROOT, o.REV_INFO AS RevInfo, 
                         o.CREATING_CO AS CreatingCo, o.STATUS, o.REV, o.WFS_ID AS WfsId, o.LOCKED_BY_NAME AS LockedByName, o.CREATING_CO_NAME AS CreatingCoName, o.APPROVAL_ACTIVITY AS ApprovalActivity, o.OBJ_ID AS ObjId, 
