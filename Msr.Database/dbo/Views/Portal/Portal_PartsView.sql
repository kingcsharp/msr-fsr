...
AS
SELECT                  o.LOCKED_BY AS LockedBy, o.UNLOCKED_BY AS UnLockedBy, o.CREATED_BY AS CreatedBy, o.CREATE_DATE AS CreateDate, o.ROOT, o.REV_INFO AS RevInfo, o.CREATING_CO AS CreatingCo, o.STATUS, 
