...
AS
SELECT     CUST.NAME AS CUST_NAME, SUP.NAME AS SUP_NAME, APA.SYS_NAME AS FILL_OBJ_DESC, FILL_PERSON.FULL_NAME AS FILLER_NAME, 
					  ...
					  dbo.A_PURCHASES_HISTORY.CUST_PURCH_NUM AS CUST_PURCH_NUM,
...
FROM         dbo.A_V_PRODUCTS_APPROVED_DATA LEFT OUTER JOIN
                      ...
                      dbo.A_V_PRODUCTS_APPROVED_DATA.ID = PURCHASE_ITEM.PRODUCT_ID LEFT OUTER JOIN 
					  A_V_ACTUAL_PARTS_APPROVED_DATA APA ON FILLS.FILL_OBJ_ID = APA.ID LEFT OUTER JOIN
                      dbo.A_V_PARTS_APPROVED_DATA PA ON APA.PART_ID = PA.ID LEFT OUTER JOIN
					  A_PARTS_HISTORY PH ON PA.HISTORY_REF_ID = PH.ID
