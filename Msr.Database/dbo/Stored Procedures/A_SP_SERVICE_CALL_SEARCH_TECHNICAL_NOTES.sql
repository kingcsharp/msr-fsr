...
*/
CREATE                                PROCEDURE A_SP_SERVICE_CALL_SEARCH_TECHNICAL_NOTES
...
or SUPPLIER_ID ='''+  @myCo  +''' OR CUSTOMER_ID = ''' +@myCo +''' OR 
CUSTOMER_ID IN (SELECT CHILD_COMPANY FROM A_COMPANIES_CHILD_LOOKUP_TABLE WHERE COMPANY =''' +@myCo +'''))'  
