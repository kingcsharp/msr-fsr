...
INSERT INTO A_ROLE_ASSIGNEE (ID,ROLE,PERSON,STATUS,SOURCE,ROLE_ASSIGNED,DRCM,MODBY)
SELECT newID(),@newID,PERSON,STATUS,'A_SP_ROLE_COPY_ONE',ROLE_ASSIGNED,getDATE(),@strNTLogin
