...
CREATE             procedure A_SP_PROCEDURE_COPY_ONE
...
--Insert the new one
INSERT INTO A_PROCEDURES_HISTORY (ID,VERB,NAME,COMMENTS,SECURITY_LEVEL,STEPS_IN_AP,WIP_MSG,DRCM,MODBY,SYSTEM_ID,DURATION,DURATION_TYPE)
SELECT @newID as ID,VERB,NAME,COMMENTS,SECURITY_LEVEL,STEPS_IN_AP,WIP_MSG,getDate(),@strNTLogin,SYSTEM_ID,DURATION,DURATION_TYPE
