CREATE PROCEDURE [dbo].[GetDeliveryTsrDetails]
	@fillId VARCHAR(50)
AS
	DECLARE 
	...
	SELECT OBJECT_ID AS PurchaseNumber, ROOT_CO_NAME AS ShipFrom, CUST_PURCH_NUM AS CustomerPo FROM A_V_PURCHASES_WITH_SUPPLIER_QUOTES, @getDate AS ShipDate WHERE PURCH_HIST_ID = @purchaseHistoryId
