...
END
GO
CREATE NONCLUSTERED INDEX [IX_A_ACTUAL_PARTS_HISTORY_02]
    ON [dbo].[A_ACTUAL_PARTS_HISTORY]([PARENT_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_A_ACTUAL_PARTS_HISTORY_01]
    ON [dbo].[A_ACTUAL_PARTS_HISTORY]([OBJECT_ID] ASC, [SERIAL] ASC)
    INCLUDE([ID], [PART_ID], [CUR_OWNER]);
