...
namespace MSR.Domain.Abstractions.Services.Workflow
{
    ...
    {
        Task<PendingApprovalNotification> GetApprovalNotificationsAsync(GetPendingApprovalsModel command);
        ...
        Task<ICollection<WorkflowLinkModel>> GetAllMyActivitiesPrivileges(int? answerUserId, ICollection<int> roleIds);
    }
}
