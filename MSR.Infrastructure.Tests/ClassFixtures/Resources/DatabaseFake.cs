...
namespace MSR.Infrastructure.Tests.ClassFixtures.Resources
{
    public class DatabaseFake
    {
        public static Mock<IUnitOfWork> DatabaseFakeSetup()
        {
        ...
        public static IServiceCollection ServiceFakeSetup(IUnitOfWork unitOfWork)
        {
