...
namespace MSR.Infrastructure.Resources.EntityFramework.Application
{
    public class UnitOfWork : IDisposable, IUnitOfWork
    {
        ...
        private IRepository<MonitorUnitofMeasure> _monitorUnitOfMeasure;
        ...
        public IRepository<WorkflowStageMap> WorkflowStageMaps { get { return _workflowStageMap ?? (_workflowStageMap = new EFRepository<WorkflowStageMap>(Context)); } }
        ...
        public IRepository<MonitorUnitofMeasure> MonitorUnitOfMeasure { get { return _monitorUnitOfMeasure ??= new EFRepository<MonitorUnitofMeasure>(Context); } }
